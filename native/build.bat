...
set SOURCES=
for %%D in (. artnet dmx serializers render spout config ui exporters generators generators\mavlink) do (
...
set INCLUDES=/I "%VCPKG_INSTALLED%\include" /I "%ROOT%src" /I "%ROOT%third_party\stb" /I "%ROOT%third_party\mavlink"
